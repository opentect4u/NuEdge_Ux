...
@Component({
  selector: 'app-non-financial-entry',
  templateUrl: './non-financial-entry.component.html',
  styleUrls: ['./non-financial-entry.component.css']
})
export class NonFinancialEntryComponent implements OnInit {
