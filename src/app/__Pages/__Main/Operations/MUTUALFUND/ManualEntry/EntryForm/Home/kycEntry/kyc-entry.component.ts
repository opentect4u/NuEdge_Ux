...
@Component({
  ...
  styleUrls: ['./kyc-entry.component.css']
})
export class KycEntryComponent implements OnInit {
  ...
  getKycType(){
    this.__dbIntr.api_call(0,'/showTrans',`trans_type_id=${this.__product_type}`).pipe(pluck("data")).subscribe(res =>{
      console.log(res);
