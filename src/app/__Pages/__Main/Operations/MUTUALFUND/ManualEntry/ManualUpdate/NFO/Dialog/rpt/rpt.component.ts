      ...
      this.__dbIntr
        .getpaginationData(
          __paginate.url +
            ...
            (('&sub_brk_cd=' + (JSON.stringify(this.__ackForm.value.sub_brk_cd.map(item => {return item["id"]}))))
              +('&euin_no=' +(JSON.stringify(this.__ackForm.value.euin_no.map(item => {return item["id"]}))))
              +('&brn_cd=' + (JSON.stringify(this.__ackForm.value.brn_cd.map(item => {return item["id"]}))))
              +('&bu_type=' + (JSON.stringify(this.__ackForm.value.bu_type.map(item => {return item["id"]}))))
              +('&rm_id=' + (JSON.stringify(this.__ackForm.value.rn_id.map(item => {return item["id"]}))))
            )
            : '')
        )
