...
@Component({
  selector: 'non-financial-form-receive',
  templateUrl: './non-financial-form-receive.component.html',
  styleUrls: ['./non-financial-form-receive.component.css']
})
export class NonFinancialFormReceiveComponent implements OnInit {
 @Input() trans_type_id:string;
  ...
  recieveForm() {
    ...
    __rcvFormForNonFin.append('product_id', this.product_id);
    __rcvFormForNonFin.append(
      'trans_id',
  ...
  resetForm = () =>{
    ...
    this.__rcvFormForNonFin.get('sub_arn_no').setValue('',{emitEvent:false});
    this.__rcvFormForNonFin.get('euin_no').setValue('',{emitEvent:false});
    this.__rcvFormForNonFin.get('client_code').setValue('',{emitEvent:false});
    this.__rcvFormForNonFin.get('scheme_name').setValue('',{emitEvent:false});
    this.__rcvFormForNonFin.patchValue({
      sub_brk_cd:'',
      client_name:'',
      client_id:'',
