...
export class AckEntryComponent implements OnInit {
  ...
  __ackUpload = new FormGroup({
    ...
    file: new FormControl(this.data.data.ack_copy_scan ? `${environment.ack_formUrl_for_fd + this.data.data.ack_copy_scan}` : '')
  })
  constructor(
  ...
  getcurrenctDatetime(){
    ...
    UploadAcknowledgement(){
      ...
      this.__dbIntr.api_call(1,'/fd/ackUpload',__ackUpload).subscribe((res: any) =>{
