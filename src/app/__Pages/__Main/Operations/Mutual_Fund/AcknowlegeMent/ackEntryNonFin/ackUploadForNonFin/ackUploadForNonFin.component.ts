...
@Component({
  selector: 'app-ackUploadForNonFin',
  templateUrl: './ackUploadForNonFin.component.html',
  styleUrls: ['./ackUploadForNonFin.component.css']
})
export class AckUploadForNonFinComponent implements OnInit {
...
constructor(
  ...
  public dialogRef: MatDialogRef<AckUploadForNonFinComponent>,
