...
@Component({
  selector: 'app-cmnDialogForDtlsView',
  templateUrl: './cmnDialogForDtlsView.component.html',
  styleUrls: ['./cmnDialogForDtlsView.component.css']
})
export class CmnDialogForDtlsViewComponent implements OnInit {
