...
@Component({
selector: 'dialogFrClient-component',
templateUrl: './dialogFrClient.component.html',
styleUrls: ['./dialogFrClient.component.css']
})
export class DialogfrclientComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogfrclientComponent>,
