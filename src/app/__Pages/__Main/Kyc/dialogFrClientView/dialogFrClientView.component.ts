...
@Component({
selector: 'dialogFrClientView-component',
templateUrl: './dialogFrClientView.component.html',
styleUrls: ['./dialogFrClientView.component.css']
})
export class DialogfrclientviewComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogfrclientviewComponent>,
