...
export class RntDashboardComponent implements OnInit {
  ...
  __menu = [{"parent_id": 4,"menu_name": "Manual Entry","has_submenu": "N","url": "/main/master/rntmodify","icon":"","id":3},
            {"parent_id": 4,"menu_name": "Upload CSV","has_submenu": "N","url": "main/master/rntUpload","icon":"","id":15}
           ]
