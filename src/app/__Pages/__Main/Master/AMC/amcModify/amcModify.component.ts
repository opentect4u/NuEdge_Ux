...
export class AmcModifyComponent implements OnInit {
  ...
  __amcForm = new FormGroup({
    ...
    cust_care_no: new FormControl('', [
      Validators.required,
      Validators.pattern('^[0-9]*$'),
    ]),
    cust_care_email: new FormControl('', [
      Validators.required,
      Validators.email,
    ]),
    ...
    if (this.__route.snapshot.queryParamMap.get('id') != null) {
      this.__dbIntr
        .api_call(
          0,
          '/amc',
          'id=' + atob(this.__route.snapshot.queryParamMap.get('id'))
        )
  ...
  submit() {
    ...
    __amc.append(
      'cus_care_no',
      this.__amcForm.value.cust_care_no > 0
        ? this.__amcForm.value.cust_care_no
        : ''
    );
    ...
    __amc.append(
      'l1_contact_no',
      this.__amcForm.value.l1_contact_no > 0
        ? this.__amcForm.value.l1_contact_no
        : ''
    );
    ...
    __amc.append(
      'l2_contact_no',
      this.__amcForm.value.l2_contact_no > 0
        ? this.__amcForm.value.l2_contact_no
        : ''
    );
    ...
    __amc.append(
      'l3_contact_no',
      this.__amcForm.value.l3_contact_no > 0
        ? this.__amcForm.value.l3_contact_no
        : ''
    );
    ...
    __amc.append(
      'l4_contact_no',
      this.__amcForm.value.l4_contact_no > 0
        ? this.__amcForm.value.l4_contact_no
        : ''
    );
    ...
    __amc.append(
      'l5_contact_no',
      this.__amcForm.value.l5_contact_no > 0
        ? this.__amcForm.value.l5_contact_no
        : ''
    );
    ...
    __amc.append(
      'l6_contact_no',
      this.__amcForm.value.l6_contact_no > 0
        ? this.__amcForm.value.l6_contact_no
        : ''
    );
    ...
    this.__dbIntr.api_call(1, '/amcAddEdit', __amc).subscribe((res: any) => {
      if (res.suc == 1) {
        if (this.__amcId > 0) {
          if (
            this.__selectAMC.data.findIndex((x: amc) => x.id == res.data.id) !=
            -1
          ) {
          ...
          this.__router
            .navigateByUrl(
              '/main/master/amcModify/' + { queryParams: { id: btoa('0') } },
