...
export class RejectTrxnComponent implements OnInit {
  ...
  /**
   * * @description This function filters the global search input for the reject transaction table.
   ...
   * @param $event This function filters the global search input for the reject transaction table.
   */
  filterGlobal = ($event) => {
   ...
   * @description This function is used to get the columns for the reject transaction table.
