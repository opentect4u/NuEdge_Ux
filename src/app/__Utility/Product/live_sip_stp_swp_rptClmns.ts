...
export class live_sip_stp_swp_rpt{
     public static columns = [
      ...
      {field:'euin_no',header:'EUIN',isVisible:['LS-1','LS-2','LS-3','TS-1','TS-2','TS-3','P','P2','P3'],width:"10rem"},
      ...
      {field:'to_cat_name',header:'Category',isVisible:['LS-2','TS-2','P2'],width:"15rem"},
      {field:'to_subcat_name',header:'Sub Category',isVisible:['LS-2','TS-2','P2'],width:"21rem"},
      {field:'scheme_name',header:'Transferor Scheme',isVisible:['LS-2','TS-2','P2'],width:"28rem"},
