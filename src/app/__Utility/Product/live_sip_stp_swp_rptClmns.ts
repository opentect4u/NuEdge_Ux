...
export class live_sip_stp_swp_rpt{
     public static columns = [
      ...
      {field:'scheme_name_to',header:'To Scheme',isVisible:['LS-2','TS-2','P2'],width:"28rem"},
      {field:'scheme_name',header:'From Scheme',isVisible:['LS-2','TS-2','P2'],width:"28rem"},
      ...
      {field:'duration',header:'Duration',isVisible:['LS-1','LS-2','LS-3','TS-1','TS-2','TS-3','P','P2','P3'],width:"16rem"},
