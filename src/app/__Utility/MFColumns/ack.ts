...
export class MfackClmns {
  ...
  public static Deatils: column[] = [
    ...
    { field: 'second_client_pan', header: 'Second Holder PAN',width:'5rem' },
    { field: 'second_client_kyc_status', header: 'Second Holder KYC Status',width:'5rem' },
    { field: 'third_client_name', header: 'Third Holder Name',width:'15rem' },
    { field: 'third_client_code', header: 'Third Holder Code',width:'5rem' },
