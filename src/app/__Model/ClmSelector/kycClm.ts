...
export class kycClm {
  public static Summary_copy:column[] = [
    ...
    {field:'app_form_view',header:'APP View',width:'7rem'},
    {field:'ack_form_view',header:'ACK View',width:'7rem'},
    ...
    {field:'client_name',header:'Client Name',width:'18rem'},
  ...
  public static Details:column[] = [
    {field:'edit',header:'Edit',width:'5rem'},
    {field:'app_form_view',header:'APP View',width:'7rem'},
    {field:'entry_dt',header:'Entry Date',width:'7rem'},
    {field:'ack_form_view',header:'ACK View',width:'7rem'},
    // {field:'mu_frm_view',header:'Manual Update View'},
    {field:'tin_no',header:'TIN',width:'8rem'},
    {field:'bu_type',header:'Business Type',width:'8rem'},
  ...
  public static clmSelector =[
    ...
    {id:'app_form_view',text:'APP View',width:'7rem'},
    {id:'entry_dt',text:'Entry Date',width:'7rem'},
    {id:'ack_form_view',text:'ACK View',width:'7rem'},
    ...
    {id:'client_name',text:'Client Name',width:'18rem'},
