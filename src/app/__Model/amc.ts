...
export interface amc {
  ...
  head_contact_per_email?: string
  head_ofc_addr?: string

  local_ofc_contact_per?: string
  local_contact_per_mob?: string
  local_contact_per_email?: string
  local_ofc_addr?: string
